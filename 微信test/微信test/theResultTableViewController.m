//
//  theResultTableViewController.m
//  微信test
//
...
@interface theResultTableViewController ()

@property (nonatomic, strong) NSArray *results;

@end

@implementation theResultTableViewController
...
- (void)updateSearchResultsForSearchController:(UISearchController *)searchController {
    ...
    for (theFriendsGroupModel *group in _datas) {
        NSArray *filterArray = [group.friends filteredArrayUsingPredicate:predicate];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    theFriendsModel *friend = _results[indexPath.row];
    cell.friend = friend;
